...
// Client lists the client service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the client service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// Add returns an endpoint that makes HTTP requests to the client service add
// server.
func (c *Client) Add() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("client", "add", err)
		}
		return decodeResponse(resp)
	}
}

// Get returns an endpoint that makes HTTP requests to the client service get
// server.
func (c *Client) Get() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("client", "get", err)
		}
		return decodeResponse(resp)
	}
}

// Show returns an endpoint that makes HTTP requests to the client service show
// server.
func (c *Client) Show() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("client", "show", err)
		}
		return decodeResponse(resp)
	}
}
